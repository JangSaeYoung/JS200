...
const commentInput = document.getElementsByClassName('input-comment');
...
function registerComment(value){
    ...
    const newComment = `<span class="point-span userID">saeYoung-26WE</span><span>${value}</span><span>X</span>`;
...
submitBtn[0].addEventListener('click', () => {
    ...
    console.log(commentInput[0].value)
