...
// //app2.js
// import * as add from './add.js.js';  // add.js 모듈을 *을 이용하여 전체를 가져온다. / 모듈 전체를 가리키는 이름이 있어야 하므로 as를 사용하여 이름을 줌.(add)
// import './sideeffect.js.js';  // from 작성안함. 
...
// //app3.js
// import {value} from './value.js.js';   // value.js 모듈로부터 value를 가져와 
